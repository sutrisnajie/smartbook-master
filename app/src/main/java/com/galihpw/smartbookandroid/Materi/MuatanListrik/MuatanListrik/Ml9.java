...
public class Ml9 extends Fragment implements View.OnTouchListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.ml9, container, false);
        videoView1 = (CustomVideoView) rootView.findViewById(R.id.ml9vv1);
